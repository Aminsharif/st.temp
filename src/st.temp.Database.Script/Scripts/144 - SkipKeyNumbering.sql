alter table CylinderEntries
    add SkipKeyNumbering bit not null default 0
...
Alter View vwCylinderEntriesWithFunction as
        ...
        while(@counter < @replicationCounter)
            Begin
                ...
                into CylinderEntries (Id, OrderId, KeyingSystemId, Locking, DoorNumber, Description, CylindersCount,
                                      ...
                                      PartVariantNumber, KeyLabel, IsCalculationRelevant, SkipKeyNumbering)
                select Id,
                       OrderId,
                       KeyingSystemId,
                       Locking,
