Alter table CylinderEntriesToCylinderEntries
    add ConnectionGroup int null
    ...
    Begin Transaction
        while(@counter < @replicationCounter)
            Begin
                ...
                select NewId(), sTempSourceId.NewId, sTempTargetId.NewId, c.ConnectionType, @createdBy, GETUTCDATE(), c.ConnectionGroup
