Create Procedure spReplicateKeyingSystem(
        ...
        while(@counter < @replicationCounter)
            Begin
                ...
                WITH CylinderEntriesForKeyingSystem
                         AS (
                        SELECT Id, ParentCylinderEntryId, 0 as Position
                        ...
                        FROM CylinderEntries
                                 INNER JOIN CylinderEntriesForKeyingSystem
                                            ON CylinderEntries.ParentCylinderEntryId = CylinderEntriesForKeyingSystem.Id
                ...
                WITH CylinderSuperordinateKeysForKeyingSystem
                         AS (
                        SELECT Id, ParentSuperordinateKeyId, 0 as Position
                ...
                ;
                With NewSuperordinateKeys as (
                    select sTemp.NewId        Id,
                           @newOrderId        OrdrId,
                           ...
                           Position
                    from SuperordinateKeys
                             inner join #TempSuperordinateKeysWithNewIds sTemp on SuperordinateKeys.Id = sTemp.Id
                    where KeyingSystemId = @keyingSystemId)
                insert
