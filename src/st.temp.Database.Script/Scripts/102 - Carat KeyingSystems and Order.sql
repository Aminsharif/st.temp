Alter table Orders
    add
        ...
        KeyEmbossingId uniqueidentifier,
        constraint FK_Orders_CaratCommissionId foreign key (CaratCommissionId) references CaratCommissions,
        constraint FK_Orders_KeyEmbossingId foreign key (KeyEmbossingId) references KeyEmbossings
Go

Alter table KeyingSystemTypes
    add IsCarat bit not null default 0;
...
where Id in
      ('08E53D25-D843-4F60-BB56-448E0C16D092',
       '08E53D25-D843-4F60-BB56-448E0C16D093',
       '08E53D25-D843-4F60-BB56-448E0C16D094',
       '08E53D25-D843-4F60-BB56-448E0C16D095',
       '08E53D25-D843-4F60-BB56-448E0C16D096',
       '08E53D25-D843-4F60-BB56-448E0C16D097',
...
Alter table KeyingSystems
    add CaratProfileId UNIQUEIDENTIFIER,
        constraint FK_KeyingSystems_CaratProfileId foreign key (CaratProfileId) references CaratProfiles
Go
...
BEGIN
    ...
    Insert into KeyingSystems (Id, KeyingSystemTypeId, KeyingSystemKindId, CaratProfileId, KeyingSystemNumber,
                               CreatedBy,
                               KeyNumberingType, Created)
    VALUES (@keyingSystemId, @keyingSystemTypeId, @keyingSystemKindId, @caratProfileId,
            @keyingSystemNumber, @createdBy,
